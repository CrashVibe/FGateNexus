...
--> statement-breakpoint
INSERT INTO `__new_target`("channel_id", "config", "created_at", "enabled", "guild_id", "id", "platform", "server_id", "type", "updated_at") SELECT "channel_id", "config", "created_at", "enabled", CASE WHEN type = 'group' THEN channel_id END AS guild_id, "id", 'onebot', "server_id", "type", "updated_at" FROM `target`;--> statement-breakpoint
