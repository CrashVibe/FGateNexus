                                            ...
                                            <div class="flex flex-wrap gap-1">
                                                ...
                                                >
                                                    <template #trigger>
                                                        <n-tag
                                                            :type="
                                                                formData.mcToPlatformTemplate.includes(tag.value)
                                                                    ? 'primary'
                                                                    : 'default'
                                                            "
                                                            ...
                                                            size="small"
                                                            @click="
                                                                insertPlaceholder('mcToPlatformTemplate', tag.value)
                                                            "
                                                        >
                                                            {{ tag.value }}
                                                        </n-tag>
                                            ...
                                            <div class="flex flex-wrap gap-1">
                                                ...
                                                >
                                                    <template #trigger>
                                                        <n-tag
                                                            :type="
                                                                formData.platformToMcTemplate.includes(tag.value)
                                                                    ? 'success'
                                                                    : 'default'
                                                            "
                                                            class="cursor-pointer"
                                                            size="small"
                                                            @click="
                                                                insertPlaceholder('platformToMcTemplate', tag.value)
                                                            "
                                                        >
                                                            {{ tag.value }}
                                                        </n-tag>
