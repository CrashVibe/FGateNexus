                    ...
                    <n-card class="h-fit" size="small" title="基础设置">
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <n-form-item label="绑定数量" path="maxBindCount">
                                <n-input-number
                                    v-model:value="formData.maxBindCount"
                                    class="w-full"
                                    ...
                                    <div class="flex flex-wrap gap-1">
                                        <n-tooltip v-for="tag in bindSuccessVariables" :key="tag.value" trigger="hover">
                                            <template #trigger>
                                                <n-tag
                                                    :type="
                                                        formData.bindSuccessMsg.includes(tag.value)
                                                            ? 'primary'
                                                            : 'default'
                                                    "
                                    ...
                                    <div class="flex flex-wrap gap-1">
                                        <n-tooltip v-for="tag in bindFailVariables" :key="tag.value" trigger="hover">
                                            <template #trigger>
                                                <n-tag
                                                    :type="
                                                        formData.bindFailMsg.includes(tag.value) ? 'primary' : 'default'
                                                    "
                                                    class="cursor-pointer"
                                                    size="small"
                                    ...
                                    <div class="flex flex-wrap gap-1">
                                        ...
                                        >
                                            <template #trigger>
                                                <n-tag
                                                    :type="
                                                        formData.unbindSuccessMsg.includes(tag.value)
                                                            ? 'primary'
                                                            : 'default'
                                                    "
                                                    class="cursor-pointer"
                                    ...
                                    <div class="flex flex-wrap gap-1">
                                        <n-tooltip v-for="tag in unbindFailVariables" :key="tag.value" trigger="hover">
                                            <template #trigger>
                                                <n-tag
                                                    :type="
                                                        formData.unbindFailMsg.includes(tag.value)
                                                            ? 'primary'
                                                            : 'default'
                                                    "
                                                    class="cursor-pointer"
                                    ...
                                    <div class="flex flex-wrap gap-1">
                                        <n-tooltip v-for="tag in noBindKickVariables" :key="tag.value" trigger="hover">
                                            <template #trigger>
                                                <n-tag
                                                    :type="
                                                        formData.nobindkickMsg.includes(tag.value)
                                                            ? 'primary'
                                                            : 'default'
                                                    "
                                                    class="cursor-pointer"
                                    ...
                                    <div class="flex flex-wrap gap-1">
                                        <n-tooltip v-for="tag in unbindKickVariables" :key="tag.value" trigger="hover">
                                            <template #trigger>
                                                <n-tag
                                                    :type="
                                                        formData.unbindkickMsg.includes(tag.value)
                                                            ? 'primary'
                                                            : 'default'
                                                    "
                                                    class="cursor-pointer"
