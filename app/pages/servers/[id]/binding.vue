                        ...
                        <div class="mt-2 space-y-2">
                          ...
                          <div class="flex flex-wrap gap-1">
                            ...
                            >
                              <UBadge
                                :color="
                                  formData.config.bindFailMsg.includes(
                                    tag.value,
                                  )
                                    ? 'primary'
                                    : 'neutral'
                      ...
                      >
                        ...
                        <div class="mt-2 space-y-2">
                          ...
                          <div class="text-muted text-sm">
                            预览：
                            <MinecraftText
                              v-if="noBindKickMsgPreview"
                              :text="noBindKickMsgPreview"
                            />
                          </div>
                        </div>
                      </UFormField>
                      ...
                      >
                        ...
                        <div class="mt-2 space-y-2">
                          ...
                          <div class="text-muted text-sm">
                            预览：
                            <MinecraftText
                              :text="String(unbindKickMsgPreview ?? '')"
                            />
                          </div>
                        </div>
                      </UFormField>
...
const autoRenameNamePreview = computed(() => {
  ...
  return renderBindRenameName(formData.config.autoRenameNameTemplate, {
    platform: "onebot",
    playerName: "Steve",
    socialNickname: "小明",
    socialUid: "114514",
...
const unbindKickMsgPreview = computed(() => {
  ...
  return renderUnbindKick(formData.config.unbindkickMsg, "114514");
});
